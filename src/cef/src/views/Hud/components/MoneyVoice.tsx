import './assets/styles/compiled-css/MoneyVoice.css'
...
const MoneyVoice = () => {
  ...
  const minimapPosition = useMemo(() => ({
    ...
    top: `calc(${hudState.topY}% - 3rem)`,
    left: `calc(${hudState.leftX}% + 1.5rem)`
  }), [hudState.topY, hudState.leftX])
  ...
  return (
    <div className="money-voice-component"
